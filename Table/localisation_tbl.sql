...
SELECT DISTINCT org_plot_id, max(yr_measured), longitude,latitude,srid,org_code_db
-- SECOND QUERY - remove all doublons on plots location
FROM
(
        -- FIRST QUERY - get all coarse localition plots
        ---------------------------------------
